...
public class PixToolsNestedTest extends TestCase {
    ...
    public void testNest2Ring() throws Exception {
            ...
            int ipnest = 3;
            int nside = 2;
            int ipring = (int) PixToolsNested.nest2ring(nside, ipnest);
            assertEquals("ipring=" + ipring, 0, ipring, 1e-10);
            ipnest = 0;
            nside = 2;
            ipring = (int) PixToolsNested.nest2ring(nside, ipnest);
    ...
    public void testRing2Nest() throws Exception {
            ...
            int ipnest = (int) PixToolsNested.ring2nest(nside, ipring);
            assertEquals("ipnest=" + ipnest, 3, ipnest, 1e-10);
            ipring = 13;
            nside = 2;
            ipnest = (int) PixToolsNested.ring2nest(nside, ipring);
